...
linkml_meta = LinkMLMeta(
    {
        ...
        "description": "A schema defining Semantic Data Types (SDT) situated above "
        "physical database or programming types. Encompasses metadata, "
        "mappings, validation, generation, and agentic instructions.",
        ...
        "prefixes": {
            ...
            "sdt": {"prefix_prefix": "sdt", "prefix_reference": "https://w3id.org/dartfx/semanticdt/"},
...
class TargetEnvironmentEnum(StrEnum):
    """
...
class SemanticDataType(ConfiguredBaseModel):
    ...
    name: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SemanticDataType", "ClassificationSystem"]}},
    )
...
class ConceptReference(ConfiguredBaseModel):
    ...
    uri: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ConceptReference", "ClassificationSystem"]}},
    )
    vocabulary: str | None = Field(
        default=None,
        description="""Name of the vocabulary or ontology (e.g., SKOS, DDI-CDI, Wikidata, LCSH).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ConceptReference"]}},
    )
    ...
    match_type: str | None = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ConceptReference"], "ifabsent": "string(exactMatch)"}},
    )
...
class StorageType(ConfiguredBaseModel):
    ...
    data_type: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["StorageType"]}},
    )
    format_modifier: str | None = Field(
        default=None,
...
class ValidationRule(ConfiguredBaseModel):
    ...
    rule_type: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ValidationRule"]}},
    )
    ...
    code_snippets: list[CodeSnippet] | None = Field(
        default=None,
        description="""Environment-specific code snippets or expressions implementing the validation logic.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ValidationRule", "GenerationRule"]}},
    )
...
class CodeSnippet(ConfiguredBaseModel):
    ...
    code: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["CodeSnippet"]}},
    )
...
class GenerationRule(ConfiguredBaseModel):
    ...
    generator_type: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["GenerationRule"]}},
    )
...
class AgentInstruction(ConfiguredBaseModel):
    ...
    guidelines: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["AgentInstruction"]}},
    )
    system_prompt_snippet: str | None = Field(
        default=None,
...
class AgentSkill(ConfiguredBaseModel):
    ...
    tool_name: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["AgentSkill"]}},
    )
...
class ScopeContext(ConfiguredBaseModel):
    ...
    geospatial_coverage: GeospatialCoverage | None = Field(
        default=None,
        description="""Geospatial region or country coverage details.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ScopeContext"]}},
    )
    ...
    governing_institution: str | None = Field(
        default=None,
...
class TemporalCoverage(ConfiguredBaseModel):
    ...
    start_date: str | None = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["TemporalCoverage"], "is_a": "iso_date"}},
    )
...
class DisplayFormat(ConfiguredBaseModel):
    ...
    input_mask: str | None = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DisplayFormat"]}},
    )
    ...
    formatting_regex: str | None = Field(
        default=None,
...
class Example(ConfiguredBaseModel):
    ...
    value: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Example"]}},
    )
    is_valid: bool = Field(
        default=...,
